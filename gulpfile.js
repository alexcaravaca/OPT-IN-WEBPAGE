...
gulp.task('default', ['assemble', 'sass', 'fonts', 'notify:server'], function(){
    ...
    watch(globs, watchOptions, function(cb){
      return executeTask(['reloadBrowsers']);
    });

    watch('app/{assets,components,pages}/**/*.scss', watchOptions, function(cb){
      return executeTask(['sass']);
    });

    watch('app/**/*.{hbs,json}', watchOptions, function(cb){
      return executeTask(['assemble']);
    });

    watch('app/assets/fonts/*', watchOptions, function(cb){
      return executeTask(['fonts','reloadBrowsers']);
    });

    watch('app/{assets,components,pages}/**/*.js', watchOptions, function(cb){
